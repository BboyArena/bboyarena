...
export const MOVES_COPY: Record<LocaleCode, MovesCopy> = {
  'en-US': {
    ...
    playable: 'Playable now', prototype: 'Catalogued prototype', beats: 'beats', skills: 'Skills', execution: 'Variation instructions', path: 'Direction guide',
  ...
  'it-IT': {
    ...
    playable: 'Giocabile ora', prototype: 'Prototipo catalogato', beats: 'beat', skills: 'Abilità', execution: 'Istruzioni della variante', path: 'Guida direzionale',
  ...
  'es-419': {
    ...
    playable: 'Jugable ahora', prototype: 'Prototipo catalogado', beats: 'beats', skills: 'Habilidades', execution: 'Instrucciones de la variante', path: 'Guía direccional',
  ...
  'pt-BR': {
    ...
    playable: 'Jogável agora', prototype: 'Protótipo catalogado', beats: 'beats', skills: 'Habilidades', execution: 'Instruções da variação', path: 'Guia direcional',
