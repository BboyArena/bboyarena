...
Detailed implementation belongs in the [game scene and screen architecture](./docs/threejs-scene-architecture.md). The authored move format and current playable inventory are documented in the [move catalog guide](./docs/move-catalog.md). The active motion, animation, and replay work is tracked in the [implementation plan](./docs/plan.md). Repository-wide boundaries are defined by the [current architecture](../../docs/current-architecture.md).
